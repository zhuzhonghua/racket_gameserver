...
<dt>
    <h4 class="name" id="Field"><span class="type-signature"></span>new Field<span class="signature">(message, rule, type, name, id, <span class="optional">options</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="parent"><span class="type-signature"></span>parent<span class="type-signature"> :<a href="ProtoBuf.Reflect.T.html">ProtoBuf.Reflect.T</a>|null</span></h4>
...
<dt>
    <h4 class="name" id="type"><span class="type-signature"></span>type<span class="type-signature"> :string|{name: string, wireType: number}</span></h4>
...
<dt>
    <h4 class="name" id="decode"><span class="type-signature"></span>decode<span class="signature">(wireType, buffer, <span class="optional">skipRepeated</span>)</span><span class="type-signature"> &rarr; {*}</span></h4>
...
<dt>
    <h4 class="name" id="toString"><span class="type-signature"></span>toString<span class="signature">(<span class="optional">includeClass</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="verifyValue"><span class="type-signature"></span>verifyValue<span class="signature">(value, <span class="optional">skipRepeated</span>)</span><span class="type-signature"> &rarr; {*}</span></h4>
